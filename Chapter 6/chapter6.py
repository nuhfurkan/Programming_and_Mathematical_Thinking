...
def exercise1():
    ...
    sc = (1/3 + 1/6) + 1/2
    print((fr == sc))
    # fr and sc should be equal in terms of mathematics, however, due to
    # floating-point arithmatic they are not
...
#         return result
#
#     def reducedMap(fn, ls):
#         return reduce(fn, ls, ())
#
#     def reducedFilter(fn, ls):
#         for i in reduce(fn, ls, ()):
#             print(i)
#
#     file = open("name")
#     reducedFilter(lambda x: str(x).startswith("John"), file)
# Something wrong with this part ################################
